...
function postSummary(p){const a=p.actualSnapshot||p;return {date:p.date,postedAt:p.actualAt||null,themeId:a.parentId,category:a.topicGroup,purpose:a.primaryAxis,format:a.format,advertised:!!(a.advertised||demo.ads.some(ad=>ad.postId===p.id)),products:a.skuIds||[],body:a.caption||a.body||'',stories:a.stories||[],cta:a.cta||''};}
